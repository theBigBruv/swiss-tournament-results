...
# This function was modified to handle tie (draw) outcomes
def testStandingsBeforeMatches():
    ...
    if matches1 != 0 or matches2 != 0 or wins1 != 0 or wins2 != 0 or ties1 != 0 or ties2 != 0:
        raise ValueError(
            "Newly registered players should have no matches or wins or ties.")
...
def testReportMatches():
    ...
    outcome1 = "winandloss"
    outcome2 = "winandloss"
    reportMatch(outcome1, id1, id2)
    reportMatch(outcome2, id3, id4)
    standings = playerStandings()
